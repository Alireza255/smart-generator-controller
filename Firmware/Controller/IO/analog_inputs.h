...
#define CONTROLLER_REF_VOLTAGE 5.0f
#define ANALOG_INPUTS_NUMBER_OF_SAMPLES 8
#define ANALOG_INPUTS_MIN_VBAT (voltage_t)6.5 // THE MIN VBAT THAT THE ECU CAN HAVE BEFORE ANALOG INPUT READINGS START BEING WRONG
