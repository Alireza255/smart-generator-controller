...
#define IGNITION_OUTPUT_4_Pin GPIO_PIN_12
#define IGNITION_OUTPUT_4_GPIO_Port GPIOB
#define IGNITION_OUTPUT_3_Pin GPIO_PIN_13
#define IGNITION_OUTPUT_3_GPIO_Port GPIOB
#define IGNITION_OUTPUT_2_Pin GPIO_PIN_14
#define IGNITION_OUTPUT_2_GPIO_Port GPIOB
#define IGNITION_OUTPUT_1_Pin GPIO_PIN_15
#define IGNITION_OUTPUT_1_GPIO_Port GPIOB
#define INJECTOR_OUTPUT_4_Pin GPIO_PIN_6
#define INJECTOR_OUTPUT_4_GPIO_Port GPIOC
#define INJECTOR_OUTPUT_3_Pin GPIO_PIN_7
#define INJECTOR_OUTPUT_3_GPIO_Port GPIOC
#define INJECTOR_OUTPUT_2_Pin GPIO_PIN_8
#define INJECTOR_OUTPUT_2_GPIO_Port GPIOC
#define INJECTOR_OUTPUT_1_Pin GPIO_PIN_9
